...
const Pokemon : React.FC<PokemonProps> = ({name, image, innerRef}) => {
    ...
    return (
        <React.Fragment>
            ...
            >
                <div className='flex flex-row cursor-pointer shadow-lg bg-red-50 border-r-4  gap-4 items-center p-2 rounded'>
                    ...
                    <div><span className="accent-red-700">{name}</span></div>
                </div>
            </div>
        </React.Fragment>
    )
